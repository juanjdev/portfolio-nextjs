  ...
  return (
    <Container>
      ...
      <Section delay={0.1}>
        ...
        <Paragraph>
          I have been passionate about new learning, challenges and creativity,
          this is how I discovered my passion for development and programming.
          Thanks to this, I have been able to work as a developer in an
          academic, personal and professional level.
        </Paragraph>
      ...
      <Section delay={0.3}>
        ...
        <List>
          ...
          <ListItem>
            <Link href="https://www.linkedin.com/in/juanj-blanco/" target="_blank">
              <Button
                variant="ghost"
                colorScheme="teal"
        ...
        <p>
          Join me and feel free to contact me on any of my sites on the web, or
          also by my email, you have a button just below, I know we can do
